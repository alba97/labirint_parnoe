    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
           ...
           // char flag = ' ';
            ...
            string[] line = File.ReadAllLines(/*@"small-test-in.txt"*/@"large-test-in.txt", Encoding.Default);//@"large-test-out.txt"
           // string[] line2 = File.ReadAllLines(@"large-test-in.txt", Encoding.Default);
           


            int kol_vo_str = Convert.ToInt32(line[0]);
            //int kol_vo_str2 = Convert.ToInt32(line2[0]);
            ...
            while (kol_vo_str != 0) 
            {
                ...
                path = world[0];
                       repath=world[1];
                       //String[] world2 = line2[m].Split(new char[] { ' ' }, StringSplitOptions.RemoveEmptyEntries);
                       //path2 = world2[0];
                       //repath2 = world2[1];
            ...
            for (int i = 1; i < repath.Length; i++)
            {
                ...
                for (int j = 0; j < Math.Abs(ymax - ymin); j++)
                {
                        ...
                        Console.WriteLine("делаю");
                        pii +=    maze[j] + "\r\n";
                        
                    //StreamWriter  writer = new StreamWriter(@"small-test-out.txt")
                    //{
                    //    writer.Write(maze[j],Encoding.Default);
                    //}
            ...
            File.WriteAllText(@"large-test-out.txt", pii);//@"large-test-out.txt"@"small-test-out.txt",
